...
echo "⚠️  MongoDB is not installed in this environment."
echo ""
echo "🚀 Starting mock API for frontend testing..."
echo ""
echo "You can now test:"
echo "  ✅ Login/Register UI (visual only)"
echo "  ✅ Calculator pages (work without database)"
echo "  ❌ Dashboard & other pages (need real backend)"
echo ""
echo "⚡ For full functionality, install MongoDB or use MongoDB Atlas"
echo ""

# Create a simple mock server if needed
cd /home/nathan/fix-flip-portal/backend

cat > mock-server.js << 'MOCKEOF'
